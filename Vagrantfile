Vagrant.configure("2") do |config|
  ...
  config.vm.define :master do |master|
    ...
    master.vm.network :private_network, ip: "11.224.113.250", netmask: "255.255.252.0"
    master.vm.network :private_network, ip: "11.10.11.200", netmask: "255.255.255.0"
  ...
  %w{node1 node2 node3}.each_with_index do |name, i|
    config.vm.define name do |node|
      ...
      node.vm.network :private_network, ip: "11.224.113.#{i + 11}", netmask: "255.255.252.0", bridge: "ens160"
      node.vm.network :private_network, ip: "11.10.11.#{i + 11}", netmask: "255.255.255.0", bridge: "ens192"
